...
class OBSSubtitleDisplay:
    def __init__(self):
        ...
        self.subtitle_source_name = "Farsi_Subtitles"
        self.last_text = ""
        self.last_update = 0
...
def script_load(settings):
    ...
    print("=== FARSI SUBTITLE DISPLAY SCRIPT LOADED ===")
...
def script_unload():
    ...
    print("Farsi Subtitle Display script unloaded") 